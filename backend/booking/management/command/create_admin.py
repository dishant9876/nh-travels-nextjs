...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        user.email = email
        user.is_staff = True             # fixed: was False
        ...
        if created:
            ...
            self.stdout.write(self.style.SUCCESS(f"Superuser '{username}' already exists. Permissions/password have been updated."))